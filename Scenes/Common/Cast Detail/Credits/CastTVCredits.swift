...
protocol CastTVCreditsDelegate: AnyObject {
...
extension CastTVCredits: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        delegate?.selectedTVCredits(tvID: selectedItemID)
    }
}

extension CastTVCredits: UICollectionViewDelegateFlowLayout {
