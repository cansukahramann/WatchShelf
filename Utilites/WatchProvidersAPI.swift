...
enum WatchProvidersAPI: TargetType {
    
    case movieProvider(movieID: Int)
    case tvProvider(tvID: Int)
    ...
    var path: String {
        switch self {
        case .movieProvider(let movieID):
            "movie/\(movieID)/watch/providers"
        case .tvProvider(let tvID):
